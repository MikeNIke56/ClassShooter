...
struct Z_CompiledInDeferFile_FID_ClassShooter_ClassShooter_ClassShooter_Source_ClassShooter_Public_RocketLauncher_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARocketLauncher, ARocketLauncher::StaticClass, TEXT("ARocketLauncher"), &Z_Registration_Info_UClass_ARocketLauncher, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARocketLauncher), 913579152U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ClassShooter_ClassShooter_ClassShooter_Source_ClassShooter_Public_RocketLauncher_h_748329608(TEXT("/Script/ClassShooter"),
